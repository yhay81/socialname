...
static OPERATIONS: [PublishedApiOperation; 38] = [
    ...
    PublishedApiOperation {
        ...
        required_scope: ApiKeyScope::WorkspaceRead,
        tag: "organization",
        summary: "Read the workspace-backed organization and current membership.",
        request_schema: None,
        parameters: NONE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("organization_resource"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Get,
        ...
        required_scope: ApiKeyScope::WorkspaceRead,
        tag: "organization",
        summary: "List one bounded organization member page without subject references.",
        request_schema: None,
        parameters: PAGE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("organization_member_page"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Post,
        path: "/v1/organization/members",
        operation_id: "createOrganizationMember",
        required_scope: ApiKeyScope::WorkspaceRead,
        tag: "organization",
        summary: "Create or exactly replay one tenant-private organization membership.",
        request_schema: Some("organization_member_create_request"),
        parameters: NONE,
        success_statuses: REPLAYABLE_CREATED,
        response: PublishedResponseKind::Json("organization_member_resource"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Patch,
        path: "/v1/organization/members/{membership_id}",
        operation_id: "updateOrganizationMember",
        required_scope: ApiKeyScope::WorkspaceRead,
        tag: "organization",
        summary: "Apply one role- and revision-guarded membership action.",
        request_schema: Some("organization_member_patch_request"),
        parameters: NONE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("organization_member_resource"),
        returns_location: false,
    ...
    PublishedApiOperation {
        method: PublishedHttpMethod::Get,
        path: "/v1/organization/audit-events",
        operation_id: "listOrganizationAuditEvents",
        required_scope: ApiKeyScope::OperationsRead,
        tag: "organization",
        summary: "List a bounded target-free organization audit page.",
        request_schema: None,
        parameters: PAGE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("organization_audit_event_page"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Get,
        path: "/v1/organization/retention-policy",
        operation_id: "getOrganizationRetentionPolicy",
        required_scope: ApiKeyScope::WorkspaceRead,
        tag: "organization",
        summary: "Read the organization-wide enforced watch-retention range.",
        request_schema: None,
        parameters: NONE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("organization_retention_policy_resource"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Patch,
        path: "/v1/organization/retention-policy",
        operation_id: "updateOrganizationRetentionPolicy",
        required_scope: ApiKeyScope::WorkspaceRead,
        tag: "organization",
        summary: "Apply one revisioned organization watch-retention policy.",
        request_schema: Some("organization_retention_policy_patch_request"),
        parameters: NONE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("organization_retention_policy_resource"),
        returns_location: false,
    ...
    PublishedApiOperation {
        method: PublishedHttpMethod::Get,
        path: "/v1/reviews",
        operation_id: "listTransitionReviews",
        required_scope: ApiKeyScope::WatchRead,
        tag: "reviews",
        summary: "List confirmed account-transition reviews with evidence lineage.",
        request_schema: None,
        parameters: PAGE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("transition_review_page"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Patch,
        path: "/v1/reviews/{review_id}",
        operation_id: "updateTransitionReview",
        required_scope: ApiKeyScope::WatchWrite,
        tag: "reviews",
        summary: "Assign, acknowledge, or resolve one revisioned review.",
        request_schema: Some("transition_review_patch_request"),
        parameters: NONE,
        success_statuses: OK,
        response: PublishedResponseKind::Json("transition_review_resource"),
        returns_location: false,
    },
    PublishedApiOperation {
        method: PublishedHttpMethod::Post,
