DROP TRIGGER local_observations_are_immutable;
DROP INDEX local_observations_eligibility;
DROP INDEX local_observations_expiry;
DROP INDEX local_observations_inserted;

ALTER TABLE observation_cache_metadata RENAME TO observation_cache_metadata_v1;
...
SELECT * FROM local_observations_v1;

INSERT INTO observation_cache_metadata
SELECT * FROM observation_cache_metadata_v1;

DROP TABLE observation_cache_metadata_v1;
