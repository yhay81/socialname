"""SocialName: Supported Site Listing
...
with open("socialname/resources/data.json", "r", encoding="utf-8") as data_file:
...
with open("socialname/resources/data.json", "w") as data_file:
