...
class SherlockBaseTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # TODO(yhay81): Figure out how to fix the code so this is not needed.
    ...
    def site_data_filter(self, site_list: List[str]) -> Dict[str, List[str]]:
        """Filter Site Data.
        ...
        for site in site_list:
            with self.subTest(
                f"Checking test vector Site '{site}' exists in total site data."
            ):
    ...
    def username_check(
        self, username_list: List[str], site_list: List[str], exist_check: bool = True
    ) -> None:
        ...
        for username in username_list:
            ...
            for site, result in results.items():
                with self.subTest(
                    ...
                    if (self.skip_error_sites is True) and (
    ...
    def detect_type_check(self, detect_type: str, exist_check: bool = True) -> None:
        """Username Exist Check.
        ...
        sites_by_username: Dict[str, Any] = {}
